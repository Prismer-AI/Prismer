 ...
 */
export type IMMessageType = 'text' | 'markdown' | 'code' | 'image' | 'file' | 'tool_call' | 'tool_result' | 'system_event' | 'thinking';
/**
 * Prismer-specific metadata types
 */
export type PrismerMetadataType = 'ui_directive' | 'skill_event' | 'tool_call' | 'tool_result';
/**
 * UIDirective type (subset - see full list in docker/README.md)
 */
export type UIDirectiveType = 'SWITCH_COMPONENT' | 'LOAD_DOCUMENT' | 'SHOW_NOTIFICATION' | 'UPDATE_LAYOUT' | 'JUPYTER_ADD_CELL' | 'JUPYTER_EXECUTE_CELL' | 'JUPYTER_UPDATE_CELL' | 'JUPYTER_CLEAR_OUTPUTS' | 'LATEX_UPDATE_FILE' | 'LATEX_COMPILE' | 'LATEX_SCROLL_TO_LINE' | 'PDF_LOAD_DOCUMENT' | 'PDF_NAVIGATE_TO_PAGE' | 'PDF_HIGHLIGHT_REGION' | 'CODE_LOAD_FILES' | 'CODE_UPDATE_FILE' | 'CODE_EXECUTE' | 'CODE_TERMINAL_OUTPUT' | 'GRID_LOAD_DATA' | 'GRID_UPDATE_DATA' | 'TIMELINE_ADD_EVENT' | 'TIMELINE_NAVIGATE';
/**
 ...
 */
export type WSEventType = 'authenticated' | 'message.new' | 'message.updated' | 'typing.start' | 'typing.stop' | 'error';
/**
