...
interface SidebarContextProps {
  ...
  animate: boolean;
  /** When locked, hover-based collapse is suppressed (e.g. while a dropdown is open) */
  locked: boolean;
...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      ...
      animate={{
        width: animate ? (open ? "280px" : "56px") : "280px",
      }}
      onMouseEnter={() => setOpen(true)}
      onMouseLeave={() => {
        // Don't collapse while a dropdown/dialog is open
